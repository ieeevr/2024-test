...
<ol>
    ...
    <li style="color: #F5725E:"><strong>Why I can't click the "Pay" button although I have filled out the form correctly?</strong><br/>
      The payment can not be made unless the server confirms the form is filled out. Usually, the confirmation is done in seconds. For uploading a digital copy of Student ID, you may wait a couple of minutes for the server to receive the registration data.</li>
</ol>
