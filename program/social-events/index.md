...
<div>
    ...
    <p>
        At the ShanghaiTech University Virtual Reality and Visual Computing Center, established by esteemed scientist Jingyi Yu, provides participants with a state-of-the-art research environment for exploring Virtual Reality (VR). Core research areas include Computational Cameras and Projectors, Light Field Imaging for Vision and Graphics, Recovering “Invisible” Objects, Biomedical Imaging and Bioinformatics, and Privacy-Preserving Surveillance, all of which are invaluable to the development of sophisticated VR systems, as well as the study of human per-ception and human-machine interaction. The lab also offers a cross-scale, cross-disciplinary, universal technical platform to facilitate and advance research in other fields, such as biomedicine, cultural heritage, digital city, new media, and space technologies.
    </p>
    <img src="../../assets/images/program/social-events/SE1.png" alt="SE1" style="width: 90%"/>
    <img src="../../assets/images/program/social-events/SE2.png" alt="SE2" style="width: 90%"/>
    <h2>
        Industry Forum
    </h2>
    <p>
    ...
    <img src="../../assets/images/program/social-events/SE3.png" alt="Metaverse" style="width: 90%"/>
    <h2>
        Online Activities
    </h2>
    <p>
    ...
    <img src="../../assets/images/program/social-events/SE4.png" alt="SJTU1" style="width: 90%"/>
    <img src="../../assets/images/program/social-events/SE5.png" alt="SJTU2" style="width: 90%"/>
    <h2>
        Student Recruitment
    </h2>
    <p>
    ...
    <img src="../../assets/images/program/social-events/SE6.png" alt="Huangpu River" style="width: 90%"/>
    <h2>
        Banquet at Shangri-La
    </h2>
    <p>
